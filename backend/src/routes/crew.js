  ...
  try {
    ...
    const [m] = await sql`
      UPDATE crew_members SET
        ...
        legal_first_name = ${data.legalFirstName !== undefined ? (data.legalFirstName||null) : sql`legal_first_name`},
        legal_middle_name = ${data.legalMiddleName !== undefined ? (data.legalMiddleName||null) : sql`legal_middle_name`},
        legal_last_name = ${data.legalLastName !== undefined ? (data.legalLastName||null) : sql`legal_last_name`},
