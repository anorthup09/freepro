    ...
    const samples = {
      ...
      'event-added': { subject: "You've been added to an Event! — Summer Retreat",
        html: noticeHtml({ tag: 'Team', note: "You've been added to an Event!", color: '#E8500A',
          title: 'Summer Retreat', subtitle: 'Fred Munoz',
          intro: "You've been added to an Event! It will show on your Crew Calendar as out-of-office.",
          rows: [['Dates', '2026-08-20 to 2026-08-22'], ['Location', 'Breckenridge, CO']],
          postmark: pm }) },
      'site-photo': { subject: 'On-site photo — 02.LPL16926 LPL Focus 2026 (from Fred Munoz)',
        html: noticeHtml({ tag: 'Production', note: 'On-site photo submitted', title: 'LPL Focus 2026 — Social Media', subtitle: '02.LPL16926',
          ...
          postmark: pm }) },
      'ms-new-request': { subject: 'NEW REQUEST: Alex Northup submitted a storage/drive request for 02.LPL16926 - LPL Focus 2026',
        html: noticeHtml({ tag: 'Media Storage', note: 'New Storage Request', color: '#4a9eff',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'Please inform Ashley Robertson of storage costs and decision deadline.\n\nAlex Northup has submitted a storage email request for Ashley Robertson at LPL Financial. Please include on CC: Kelly Hueseman, Anabelle Porio',
          rows: [['Original Project Code', '02.LPL16926'], ['Main POC Name', 'Ashley Robertson'], ['Main POC Email', 'arobertson@lpl.com'],
            ['Total Media Size', '4.5 TB'], ['Yearly Cost for Subscription Service', '$950'], ['One-Time Cost for Hard Drive', '$650'],
            ['Project Description', 'Focus 2026 conference — keynote + social cutdowns'], ['Video Link(s)', 'https://f.io/review/…']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-hd-invoice': { subject: 'Invoice Needed - Alex Northup has requested an Invoice for LPL Focus 2026',
        html: noticeHtml({ tag: 'Media Storage', note: 'Invoice Needed', color: '#5ABF80',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          ...
          rows: [['Invoice Amount', '$650 (hard drive + shipping estimate)'], ['Main POC Name', 'Ashley Robertson'],
            ['Main POC Email', 'arobertson@lpl.com  (confirm with AM this is the best email for the invoice)'],
            ['Relevant Project Code', '02.LPL16926'], ['Media / Project Name / ID', 'Focus 2026 keynote + social cutdowns'],
            ['Total size of media on drive', '4.5 TB']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-hd-ship': { subject: 'HARD DRIVE NEEDED - 02.LPL16926 - LPL Focus 2026 - Ship ASAP',
        html: noticeHtml({ tag: 'Media Storage', note: 'Hard Drive Needed', color: '#e6c229',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          ...
          rows: [['Main POC Name', 'Ashley Robertson'], ['Hard Drive Shipping Address', 'Ashley Robertson\n1115 Grant St, Denver, CO 80203'],
            ['Project Code', '02.LPL16926'], ['Media / Project Name / ID', 'Focus 2026 keynote + social cutdowns'],
            ['Total size of media on drive', '4.5 TB'], ['Budget for Shipping, Drive, and Profit', '$650'], ['Project reference link', 'https://f.io/review/…']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-sub-invoice': { subject: 'A New Cold Storage Subscription Has Been Approved - INVOICE NEEDED - 02.LPL16926 - LPL Focus 2026',
        html: noticeHtml({ tag: 'Media Storage', note: 'Invoice Needed', color: '#5ABF80',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'A new cold storage subscription has been approved — reach out to confirm these details for invoicing:',
          rows: [['Project Code', '02.LPL16926'], ['Project Name', 'LPL Focus 2026'], ['Project Description', 'Focus 2026 conference footage'],
            ['Company', 'LPL Financial'], ['Main POC Name', 'Ashley Robertson'],
            ['Main POC Email', 'arobertson@lpl.com  (confirm with AM this is the best email for the invoice)'],
            ['Total Media Size', '4.5 TB'], ['Invoice Amount for 1 Year of Subscription Service', '$950'], ['Video Link(s)', 'https://f.io/review/…']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-sub-move': { subject: 'A new COLD STORAGE subscription for 02.LPL16926 - LPL Focus 2026 has been APPROVED!',
        html: noticeHtml({ tag: 'Media Storage', note: 'Move Media to Cold Storage', color: '#4a9eff',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'Please review the media information below and move all associated media to cold storage.\n\nDO NOT DELETE THIS MEDIA!!!',
          rows: [['Subscription Start Date', '2026-08-19'], ['Subscription End Date', '2027-08-19'], ['Project Code', '02.LPL16926'],
            ['Company / Client', 'LPL Financial'], ['Project Description', 'Focus 2026 conference footage'],
            ['Main POC Name', 'Ashley Robertson'], ['Main POC Email', 'arobertson@lpl.com'], ['Video Link(s)', 'https://f.io/review/…'],
            ['Total Media Size', '4.5 TB'], ['Yearly Cost for Subscription Service', '$950']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-sub-checkin': { subject: 'SUBSCRIPTION ENDING - 02.LPL16926 - LPL Focus 2026',
        html: noticeHtml({ tag: 'Media Storage', note: 'Subscription Ending', color: '#e05252',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'Please review the following subscription for 02.LPL16926 - LPL Focus 2026 ending on 2027-08-19 and reach out to the client for cold storage renewal:',
          rows: [['Company / Client', 'LPL Financial'], ['Main POC Name', 'Ashley Robertson'], ['Main POC Email', 'arobertson@lpl.com'],
            ['Video Link(s)', 'https://f.io/review/…'], ['Total Media Size', '4.5 TB'], ['Yearly Cost for Subscription Service', '$950']],
          button: { label: 'Open Media Storage', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-postclose-checkin': { subject: '12 Months Post-Close: Storage Follow-Up (02.LPL16926 - LPL Focus 2026)',
        html: noticeHtml({ tag: 'Media Storage', note: '12 Months Post-Close', color: '#a78bfa',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'The following project has lapsed 12 months of storage - 02.LPL16926 - LPL Focus 2026. Please inform Ashley Robertson of storage costs and decision deadline.',
          rows: [['Original Project Code', '02.LPL16926'], ['Main POC Name', 'Ashley Robertson'], ['Main POC Email', 'arobertson@lpl.com'],
            ['Total Media Size', '4.5 TB'], ['Yearly Cost for Subscription Service', '$950'], ['One-Time Cost for Hard Drive', '$650'],
            ['Project Description', 'Focus 2026 conference footage'], ['Video Link(s)', 'https://f.io/review/…']],
          button: { label: 'Annual Check-In', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
      'ms-expired-delete': { subject: 'NEW MEDIA READY TO DELETE - LPL Financial has declined Archive/Storage Services',
        html: noticeHtml({ tag: 'Media Storage', note: 'Media Ready to Delete', color: '#e05252',
          title: '02.LPL16926 - LPL Focus 2026', subtitle: 'LPL Financial',
          intro: 'Mason,\n\nThe following media is ready for deletion/offloading from our server and company hard drives.',
          rows: [['Client', 'LPL Financial'], ['Code', '02.LPL16926'], ['Project Name', 'LPL Focus 2026'],
            ['Total Media Size', '4.5 TB'], ['Export Reference', 'https://f.io/review/…']],
          blocks: [['', 'Please delete with impunity.\n\nIMPORTANT: Once deleted, please mark it Completed on the UM Platform (button below).']],
          button: { label: 'UM Platform', url: 'https://freepro-production.up.railway.app/reports/media-storage' }, postmark: pm }) },
    };
    const s = samples[key];
