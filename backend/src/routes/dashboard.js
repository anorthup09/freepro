    ...
    const r = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [{ role: 'user', content:
          `Write ONE short, fun, casual greeting line for a video production company's internal dashboard. Start with "Hey ${ctx.first}," then have genuine fun — riff on whatever's funniest today: their travel gig, PTO countdown, fun fact, the day of the week, their city's weather stereotype, Midwest life, production-world humor, coffee, whatever. Surprise them; don't be formulaic. If they have a travel gig or PTO coming up, that's usually comedy gold, but you're not required to use it. Keep it under 18 words, playful, a little irreverent, no hashtags, at most one emoji. Vibe examples: "Hey Alex, Mondays are Monday-ing" / "Hey Alex, it's hot af in St. Louis today, amirite?" / "Hey Alex, have fun in Chicago this week" / "Hey Alex, PTO is almost here, you can make it".\n\nWhat we know about them today:\n${facts}\n\nReply with ONLY the greeting line.` }],
      }),
    });
...
const FUN_PROMPTS = [
  ...
  "What's the first CD/tape/download you ever bought?",
  ...
  // College & school days
  'What was your college major — and would you pick it again?',
  ...
  'Dorm life or off-campus — and why?',
  ...
  'Window seat or aisle — defend it.',
  ...
  'What decade had the best everything?',
