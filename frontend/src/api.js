...
export const api = {
  ...
  eventsList: () => req('GET', '/team/events'),
  createEvent: (data) => req('POST', '/team/events', data),
  updateEvent: (id, data) => req('PATCH', `/team/events/${id}`, data),
  deleteEvent: (id) => req('DELETE', `/team/events/${id}`),
