          ...
          <div className="hub-scroll" style={{ display:'flex', gap:10, overflowX:'auto', paddingBottom:8, WebkitMaskImage:SCROLL_FADE, maskImage:SCROLL_FADE }}>
            {shown.map(p => (
              <div key={p.id} onClick={() => nav(`/project-view/${p.id}`)} className="hub-ptile"
                style={{ flex:'0 0 auto', width:180, background:'color-mix(in srgb, var(--bg2) 74%, transparent)', backdropFilter:'blur(16px) saturate(1.5)', WebkitBackdropFilter:'blur(16px) saturate(1.5)', border:'1px solid rgba(255,255,255,0.10)', borderTop:'1px solid rgba(255,255,255,0.10)', borderRadius:14, padding:'9px 13px', cursor:'pointer', boxShadow:'0 10px 24px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.08)', transition:'transform .15s ease' }}
        ...
        <div className="hub-scroll" style={{ display:'flex', gap:10, overflowX:'auto', paddingBottom:8, WebkitMaskImage:SCROLL_FADE, maskImage:SCROLL_FADE }}>
          {shown.map((p, i) => (
            <div key={p.id} onClick={() => nav(`/project-view/${p.id}`)}
              ...
              style={{ flex:'0 0 auto', width:180, background:'color-mix(in srgb, var(--bg2) 74%, transparent)', backdropFilter:'blur(16px) saturate(1.5)', WebkitBackdropFilter:'blur(16px) saturate(1.5)', border:'1px solid rgba(255,255,255,0.10)', borderTop:'1px solid rgba(255,255,255,0.10)', borderRadius:14, padding:'9px 13px', cursor:'pointer', boxShadow:'0 10px 24px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.08)', transition:'transform .15s ease', animationDelay:`${i * 0.045}s` }}
...
.hub-h1{font-family:'DM Sans','Helvetica Neue',Arial,sans-serif;font-size:38px;font-weight:900;letter-spacing:-.01em;line-height:1.05;margin:0;
  color:transparent;
  background:linear-gradient(180deg, #ffffff 0%, rgba(255,255,255,0.85) 30%, rgba(255,255,255,0.34) 52%, rgba(255,255,255,0.22) 62%, rgba(255,255,255,0.62) 82%, rgba(255,255,255,0.95) 100%);
  -webkit-background-clip:text;background-clip:text;
  filter:drop-shadow(0 0 1px rgba(255,255,255,0.35)) drop-shadow(0 1px 0 rgba(255,255,255,0.22)) drop-shadow(0 5px 12px rgba(0,0,0,0.55))}
...
.mm-banner,.mm-welcome{position:relative;overflow:hidden;border-radius:40px;
  ...
  background:linear-gradient(150deg, rgba(255,255,255,0.065), rgba(255,255,255,0.02) 55%), color-mix(in srgb, var(--bg2) 64%, transparent);
  backdrop-filter:blur(26px) saturate(1.2);-webkit-backdrop-filter:blur(26px) saturate(1.2);
  box-shadow:inset 0 1px 0 rgba(255,255,255,0.14), inset 0 -1px 1px rgba(0,0,0,0.28), 0 14px 40px rgba(0,0,0,0.36);
...
.mm-banner::before,.mm-welcome::before{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;pointer-events:none;z-index:4;
  background:linear-gradient(135deg, rgba(255,255,255,0.27), rgba(255,255,255,0.02) 34%, rgba(255,255,255,0) 56%, rgba(255,255,255,0.08) 100%);
  -webkit-mask:linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude}
:root[data-theme="light"] .mm-banner,:root[data-theme="light"] .mm-welcome{
  border-color:rgba(0,0,0,0.06);background:linear-gradient(150deg, rgba(255,255,255,0.35), rgba(255,255,255,0.18) 60%), color-mix(in srgb, #fff 72%, transparent);
  box-shadow:inset 0 1px 0 rgba(255,255,255,0.5), 0 10px 28px rgba(0,0,0,0.12)}
:root[data-theme="light"] .mm-banner::before,:root[data-theme="light"] .mm-welcome::before{
  background:linear-gradient(135deg, rgba(255,255,255,0.45), rgba(255,255,255,0) 45%, rgba(0,0,0,0.03) 100%)}
