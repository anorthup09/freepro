    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)' }}>
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'18px 26px' }}>
        <div style={{ display:'flex', alignItems:'baseline', gap:14 }}>
          ...
          <span style={{ fontSize:11, color:'#5ABF80', fontWeight:700, textTransform:'uppercase', letterSpacing:'0.08em' }}>ProFi · Project Finance</span>
        </div>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', minHeight:'70vh', padding:16 }}>
        <div style={{ maxWidth:520, textAlign:'center' }}>
          ...
          <div style={{ fontSize:20, fontWeight:800, marginBottom:8 }}>ProFi is on the way</div>
          <div style={{ fontSize:13, color:'var(--muted)', lineHeight:1.7 }}>
            Project finance in high fidelity: budget creation &amp; versioning, vendor cost
            control, and final reconciliation — with client-ready budget pages that match your
            brand. Contractor rates and travel costs from FreePro flow in automatically.
          </div>
